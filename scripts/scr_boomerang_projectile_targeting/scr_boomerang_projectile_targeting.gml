function boomerang_projectile_targeting(_count, _spread, _speed, _range) constructor {
    count = _count;
    spread = _spread;
    speed = _speed;
    range = _range;
    ...
    static start = function(_ability, _targeting_manager) {
        ...
        for (var _i = 0; _i < count; _i++) {
            ...
            _projectile.behaviour = new boomerang_projectile(_projectile, speed, _owner.look_dir + (count > 1 ? _i * (spread / (count - 1)) - spread * 0.5 : 0), range);
